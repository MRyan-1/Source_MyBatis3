...
public class MybatisTest {
    ...
    public void test3() throws IOException {
        ...
        User user1 = sqlSession1.selectOne("com.mryan.mapper.IUserMapper.findById", 1);
        ...
        // 增删改会清空二级缓存
        sqlSession1.update("com.mryan.mapper.IUserMapper.updateById", user);


        User user2 = sqlSession2.selectOne("com.mryan.mapper.IUserMapper.findById", 1);
        System.out.println(user2);
